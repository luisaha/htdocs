...
<body>
    <div class="pull-right pr-3">
        <a href="logout.php" class="btn box-arrow-in-left"><svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-box-arrow-in-left icon-fill" xmlns="http://www.w3.org/2000/svg">
